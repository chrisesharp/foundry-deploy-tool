...
if [ $? -eq 0 ]
then
    # terraform apply -var "do_token=${DO_PAT}" -var "pvt_key=$HOME/.ssh/mac_token" -var "foundry_user=${FOUNDRY_USERNAME}" -var "foundry_password=${FOUNDRY_PASSWORD}" -auto-approve
